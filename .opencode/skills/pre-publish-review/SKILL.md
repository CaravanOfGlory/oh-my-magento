...
PUBLISHED=$(npm view oh-my-magento version 2>/dev/null || echo "not published")
...
<project>oh-my-magento (npm package)</project>
...
GOAL: Review all changes heading into npm publish of oh-my-magento. These changes span {COMMIT_COUNT} commits across {FILE_COUNT} files.
...
BACKGROUND: Pre-publish review of oh-my-magento, an OpenCode plugin with 1268 TypeScript files, 160k LOC. Changes since v{PUBLISHED} are about to be published.
...
```markdown
# Pre-Publish Review — oh-my-magento
