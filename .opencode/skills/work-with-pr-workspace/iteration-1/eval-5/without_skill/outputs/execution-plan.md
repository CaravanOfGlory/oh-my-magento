...
The comment-checker hook delegates to an external Go binary (`caravanglory/go-claude-code-comment-checker`). The binary:
...
```
TypeScript (oh-my-magento)              Go Binary (go-claude-code-comment-checker)
─────────────────────────────             ──────────────────────────────────────────
hook.ts                                   main.go
...
File an issue or PR on `caravanglory/go-claude-code-comment-checker` to:
