...
These Terms of Service govern your use of oh-my-magento and oh-my-openagent, including the published CLI package, the OpenCode plugin runtime, the repository, and related distribution materials.

For these Terms, "Application" means the published `oh-my-magento` package and plugin. "Service" means the Application and related project distribution surfaces. "We" and "our" refer to the maintainer of oh-my-magento. "You" refer to the individual or entity using the Service.
