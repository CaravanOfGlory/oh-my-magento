...
OpenCode plugin (npm: `oh-my-magento`) that extends Claude Code (OpenCode fork) with multi-agent orchestration, 46 lifecycle hooks, 26 tools, skill/command/MCP systems, and Claude Code compatibility. Specializes in Magento 2 + Hyvä development. 1268 TypeScript files, 160k LOC.
