...
describe("loadJsonFile", () => {
  ...
  it("discovers JSONC-only user config (oh-my-magento.jsonc)", () => {
  ...
  "lsp": {
    "user-jsonc": {
      ...
      const userPath = join(tempBase, "oh-my-magento.jsonc")
  ...
  it("discovers JSONC-only project config (.opencode/oh-my-magento.jsonc)", () => {
  ...
  "lsp": {
    "project-jsonc": {
      ...
      const projectPath = join(tempProject, ".opencode", "oh-my-magento.jsonc")
  ...
  "lsp": {
    "conflict": {
      ...
      writeFileSync(join(tempBase, "oh-my-magento.json"), jsonContent, "utf-8")
      writeFileSync(join(tempBase, "oh-my-magento.jsonc"), jsoncContent, "utf-8")
