...
export function getTaskDir(config: Partial<OhMyMagentoConfig> = {}): string {
...
export function resolveTaskListId(config: Partial<OhMyMagentoConfig> = {}): string {
...
export function listTaskFiles(config: Partial<OhMyMagentoConfig> = {}): string[] {
