...
import { parseJsonc, PLUGIN_NAME, LEGACY_PLUGIN_NAME, OPENCODE_PLUGIN_NAME, OPENCODE_LEGACY_PLUGIN_NAME } from "../../shared"
...
function isOurPlugin(plugin: string): boolean {
  return plugin === PLUGIN_NAME || plugin.startsWith(`${PLUGIN_NAME}@`) ||
         ...
         plugin === OPENCODE_PLUGIN_NAME || plugin.startsWith(`${OPENCODE_PLUGIN_NAME}@`) ||
