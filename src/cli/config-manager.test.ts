...
describe("generateOmoConfig - model fallback system", () => {
  ...
  test("uses ultimate fallback when no providers configured", () => {
    ...
    expect(result.$schema).toBe("https://raw.githubusercontent.com/caravanglory/oh-my-openagent/dev/assets/oh-my-magento.schema.json")
  ...
  test("librarian resolves through fallback chain when Z.ai + Claude available", () => {
    ...
    // #then librarian prefers ZAI over Claude (ZAI special case)
